...
def compute_gradient_saliency_maps(samples: torch.tensor,
    ...
    scores.backward()
    # ==================================================================================================================
    # Extracting gradient of the sample
    # ==================================================================================================================
    grad_map = samples.grad.cpu().detach()
    # ==================================================================================================================
    # Computing L1 norm of each derivative
    # ==================================================================================================================
    abs_grad_map = abs(grad_map)
    # ==================================================================================================================
    # Extracting maximum over all channels
    # ==================================================================================================================
    saliency_maps, _ = torch.max(abs_grad_map, dim=1)
